...
NTLIBS: libmysql.lib ws2_32.lib advapi32.lib
UXLIBS: -L/usr/lib/mysql -lmysqlclient
DWLIBS: -L/usr/local/lib/mysql -lmysqlclient
*/
#if WIN32
#include <windows.h>
#endif
...
besFUNCTION(mys_shutdown)
  ...
  mysql_shutdown(q->hSQL,SHUTDOWN_DEFAULT);
  besRETURNVALUE = NULL;
besEND
