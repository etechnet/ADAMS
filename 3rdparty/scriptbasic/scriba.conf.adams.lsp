...
preproc (
  ...
  internal (
    ...
    dbg "$(ADAMS_PREFIX)/lib/scriba/dbg.so"
    )
  ...
  external (
    ...
    heb (
      ...
      ;    the preprocessor)
      executable "/usr/bin/scriba $(ADAMS_PREFIX)/scriba/source/heber.bas"
