		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1118 = topic_name;
_os.write_string( tmpResult1118 );
					java.lang.String tmpResult1119 = type_name;
_os.write_string( tmpResult1119 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1120 = name;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1121 = topic_name;
...
_os.write_string( tmpResult1122 );
					java.lang.String tmpResult1123 = type_name;
_os.write_string( tmpResult1123 );
					java.lang.String tmpResult1124 = subscription_expression;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1125 = name;
_os.write_string( tmpResult1125 );
					org.omg.dds.TopicHelper.write(_os,related_topic);
					java.lang.String tmpResult1126 = filter_expression;
