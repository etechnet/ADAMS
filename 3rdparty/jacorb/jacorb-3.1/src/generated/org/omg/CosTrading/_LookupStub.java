		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1054 = type;
_os.write_string( tmpResult1054 );
					java.lang.String tmpResult1055 = constr;
_os.write_string( tmpResult1055 );
					java.lang.String tmpResult1056 = pref;
