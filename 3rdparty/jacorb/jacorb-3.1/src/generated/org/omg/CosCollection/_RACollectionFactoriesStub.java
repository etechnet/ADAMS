		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1104 = collection_interface;
_os.write_string( tmpResult1104 );
					java.lang.String tmpResult1105 = impl_category;
_os.write_string( tmpResult1105 );
					java.lang.String tmpResult1106 = impl_interface;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1107 = collection_interface;
_os.write_string( tmpResult1107 );
					java.lang.String tmpResult1108 = impl_category;
_os.write_string( tmpResult1108 );
					java.lang.String tmpResult1109 = impl_interface;
