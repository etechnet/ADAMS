		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1098 = collection_interface;
_os.write_string( tmpResult1098 );
					java.lang.String tmpResult1099 = impl_category;
_os.write_string( tmpResult1099 );
					java.lang.String tmpResult1100 = impl_interface;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1101 = collection_interface;
_os.write_string( tmpResult1101 );
					java.lang.String tmpResult1102 = impl_category;
_os.write_string( tmpResult1102 );
					java.lang.String tmpResult1103 = impl_interface;
