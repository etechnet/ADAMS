...
public final class PrincipalHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(PrincipalHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.CORBA.PrincipalHelper.id(), "Principal",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.from_int(10))));
				}
			}
		}
		return _type;
	...
	{
		return "IDL:omg.org/CORBA/Principal:1.0";
	}
	public static byte[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new byte[_l_result44];
		_in.read_octet_array(_result,0,_l_result44);
		return _result;
	}
