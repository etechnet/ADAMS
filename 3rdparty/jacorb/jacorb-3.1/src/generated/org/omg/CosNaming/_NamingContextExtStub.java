		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1019 = addr;
_os.write_string( tmpResult1019 );
					java.lang.String tmpResult1020 = sn;
_os.write_string( tmpResult1020 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1021 = n;
