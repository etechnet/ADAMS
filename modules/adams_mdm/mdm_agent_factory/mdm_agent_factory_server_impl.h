...
class mdm_agent_factory_server_impl: public virtual PortableServer::RefCountServantBase,
    public virtual POA_net::etech::MDM::mdm_agent_factory_server
{

public:

    mdm_agent_factory_server_impl ( PoaHierarchy * g_poa_hierarchy, const char * name, CORBA::Boolean activate , int timeout );
    ~mdm_agent_factory_server_impl();

    // The CORBA _default_POA() API
    virtual PortableServer::POA_ptr _default_POA();
    // Signatures of IDL operations and attributes
    virtual mdm_agent_server_ptr get_server ( CORBA::Boolean inretry ) throw ( CORBA::SystemException, net::etech::MDM::mdm_agent_factory_server::LaunchFailure );

    virtual void put_ior ( mdm_agent_server_ptr srv ) throw ( CORBA::SystemException );
