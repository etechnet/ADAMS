...
public class JD_Message extends javax.swing.JDialog {
    ...
    public JD_Message(java.awt.Frame parent, boolean modal, String message, String title ,int Value_type) {
        super(parent, modal);
        ...
        jLabel1.setFont(font_B11);
        jTextArea1.setFont(font_B11);
        ...
        setCenteredFrame(320,260);
        setVisible(true);
        
    }
    
    /** Creates new form NTMC_JD_Message */    
    public JD_Message(java.awt.Frame parent, boolean modal, String message, String title ,int Value_type,int width,int height ) {
        super(parent, modal);
        setTitle("Information");
        this.JD_TYPE = Value_type;
        initComponents();
    ...
    private void closeFrame()
    {
        ...
        if(( JD_TYPE == CRITICAL ) || ( JD_TYPE == HELP) || ( JD_TYPE == INFO) || ( JD_TYPE ==  WARNING)) // OK
            this.dispose();
    }
