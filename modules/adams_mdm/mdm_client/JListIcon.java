...
public class JListIcon extends JList 
{
	...
	private boolean selezione	= true;
        ...
        private Font fontSel = new java.awt.Font ("Verdana", 1, 10);
        private Font fontNoSel = new java.awt.Font ("Verdana", 0, 10);
        private int gapIconMIN = 2;
        private int gapIconMAX = 6;
	...
	public JListIcon(IconPool iconPool)
        ...
        */
        ...
        public synchronized void addElementNotPresent(String PathIcon , String PathIconSelected , String AssociateText)
    	{
                boolean flagAdd = true;
        	for(int i=0; i<dataListIcon[2].size(); i++)
                {
                    String appoStr = (String)dataListIcon[2].elementAt(i);
                    if(appoStr.equals(AssociateText))
                    {
                        flagAdd = false;
                        break;
                    }
				...
				setFont(fontSel);    
					...
					}else
					{
						...
						//setForeground(java.awt.Color.red);
                            	...
                            	try
                            	{
                                        icon_appo = iconPool.getIcon((String)dataListIcon[1].elementAt(index));
                                	setIcon(icon_appo);
                            	}
								catch(Exception err)
                            	{
                                        icon_appo = iconPool.getIcon((String)dataListIcon[0].elementAt(index));
                                	setIcon(icon_appo);
                            	}   
                       	}
                        else 
                        ...
                        if(icon_appo != null)
                        {
                            ...
                            this.setPreferredSize(new Dimension(100,(h_icon+gapIconMAX) ));
                            this.setMaximumSize(new Dimension(100, (h_icon+gapIconMIN) ));
                            this.setPreferredSize(new Dimension(20,(h_icon+gapIconMIN) ));                            
                        }
                        //System.out.println(" getIconHeight --> "+icon_appo.getIconHeight());
                        //System.out.println(" High --> "+((Dimension)getPreferredSize()).getHeight());
