...
CLIENT_DNAME="cn=ADAMS MDM Client,ou=ASP,o=e-Tech,c=IT"
CLIENT_ALIAS="adams_mdm"
CLIENT_PW="mdm_signer_pw_1"
CLIENT_PW2="mdm_signer_pw_2"
CLIENT_KEYSTORE="$CLIENT_ALIAS".jks
CLIENT_CERTFILE="$CLIENT_ALIAS".cert

SERVER_DNAME="cn=ADAMS MDM Server,ou=ASP,o=e-Tech,c=IT"
SERVER_ALIAS="mdm_server"
SERVER_PW="mdm_signer_pw_1"
