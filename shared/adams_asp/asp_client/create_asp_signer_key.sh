...
CLIENT_DNAME="cn=ADAMS System Profiler Client,ou=ASP,o=e-Tech,c=IT"
CLIENT_ALIAS="adams_asp"
CLIENT_PW="asp_signer_pw_1"
CLIENT_PW2="asp_signer_pw_2"
CLIENT_KEYSTORE="$CLIENT_ALIAS".jks
CLIENT_CERTFILE="$CLIENT_ALIAS".cert

SERVER_DNAME="cn=ADAMS System Profiler Server,ou=ASP,o=e-Tech,c=IT"
SERVER_ALIAS="asp_server"
SERVER_PW="asp_signer_pw_1"
