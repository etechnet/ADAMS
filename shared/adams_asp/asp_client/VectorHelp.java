...
public class VectorHelp extends Vector {
    ...
    /** Creates new VectorHelp */
    public VectorHelp(String config,int idFamiglia) 
    {
        super();
        ...
        }else
        {
            ...
            {
                System.out.println("(VectorHelp-1) SQL Operation " + exc.toString());
            }
        }
    ...
    public VectorHelp(String config,String desc) 
    {
        super();
        idFamiglia = -1;
        ...
        {
            System.out.println("(VectorHelp-) SQL Operation " + exc.toString());
        }
    }
    

    private void creaVectorHelp(ResultSet rs)
    {
