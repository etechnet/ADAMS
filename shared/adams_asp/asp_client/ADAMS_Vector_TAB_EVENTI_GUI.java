...
public class ADAMS_Vector_TAB_EVENTI_GUI extends java.util.Vector implements Runnable
{
    ...
    public ADAMS_Vector_TAB_EVENTI_GUI(ADAMS_JP_Exceptions Parent) 
    {
        super();
        this.parent = Parent;
    ...
    public void run()
    {
        ...
        if(parent!=null)
        {
            this.parent.setCursor(Cur_wait);
            this.TIPO_DI_CONFIG = parent.get_INFO_CONFIG().TIPO_DI_CONFIGURAZIONE;
        }
    ...
    private ADAMS_JP_Exceptions parent = null;
