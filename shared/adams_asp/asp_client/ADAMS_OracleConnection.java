...
public class ADAMS_OracleConnection
{
     ...
     */  
     private final String host = ADAMSConf.machine;
    //private final String host = new String("20.96.136.173");  //MARVEL
    
    /**
    *Sid del Database.
    */ 
    private final String sid = ADAMSConf.oracle_SID;
    //private final String sid = new String("RDAT9"); //Marvel TEST
    
    /**
    *Sid del Database.
    */ 
    private final String oracle_PORT = ADAMSConf.oracle_port;
    ...
    */
    ...
    /*public boolean LoadDriver ()
    {
        try { 
            ...
            DBConnectionMySQL = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/adams_conf","root","root");
    ...
    {
    	System.out.println(" Apro Connessione con il Database 	--> "+driver_class);
        System.out.println("connect_string --> "+host+":"+sid);        
        
        try
        {
        	Class.forName(driver_class);        	
                	
        	String str_pwd = ADAMS_GlobalParam.STSConn.getPswd(NODO,TYPE_PWD,USER);
        	//String connect_str = new String("jdbc:oracle:thin:"+USER+"/"+str_pwd+"@"+host+":"+oracle_PORT+":"+sid);
                ...
                //DBConnection = DriverManager.getConnection(connect_str);                                        
