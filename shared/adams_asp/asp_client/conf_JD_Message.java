 ...
 * 
 * <p align="center"> <b> Class: conf_JD_Message </b> </p>
 */
public class conf_JD_Message extends javax.swing.JDialog {
    
    /** Creates new form NTMC_JD_Message */    
    public conf_JD_Message(javax.swing.JDialog parent, boolean modal, String message, String title, int Value_type) {
        super(parent, modal);
        ...
        jLabel1.setFont(conf_GlobalParam.font_B11);
        jTextArea1.setFont(conf_GlobalParam.font_B11);
    ...
    /* SENZA BOTTONI */
    public conf_JD_Message(javax.swing.JFrame parent, boolean modal, String message, String title) {
        ...
        setMessage(message);
        setTitleIcon_Type(title,JD_TYPE);
        setCenteredFrame(290,130);        
    }
      
    
    
    /** Creates new form NTMC_JD_Message */    
    public conf_JD_Message(javax.swing.JDialog parent, boolean modal, String message, String title, int Value_type, int width, int height) {
        super(parent, modal);
        this.JD_TYPE = Value_type;
        initComponents();
    ...
    /** Creates new form NTMC_JD_Message */    
    public conf_JD_Message(javax.swing.JFrame parent, boolean modal, String message, String title, int Value_type) {
        super((java.awt.Frame)parent, modal);
        this.JD_TYPE = Value_type;
        initComponents();
    ...
    /** Creates new form NTMC_JD_Message */    
    public conf_JD_Message(javax.swing.JFrame parent, boolean modal, String message, String title, int Value_type, int width, int height) {
        super((java.awt.Frame)parent, modal);
        this.JD_TYPE = Value_type;
        initComponents();
    ...
    public void setTitleIcon_Type(String str,int IconValue_type)
    {
        ...
        {
            case CRITICAL:  jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images_conf/critical.png"))); 
                            break;  //1
            
            case HELP:      jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images_conf/help.gif")));        
                            break;  //2  
                            
            case INFO:      jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images_conf/info.png")));            
                            break;  //3
            
            case WARNING:   jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images_conf/warning.png")));  
                            break;  //4
                            
            case QUESTION_YES_NO :  jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images_conf/help.gif")));        
                                    jB_yes.setVisible(true);
                                    jB_no.setVisible(true);
                                    jB_ok.setVisible(false);
                                    break;  //5
                                    
            case WARNING_YES_NO :   jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images_conf/warning.png")));        
                                    jB_yes.setVisible(true);
                                    jB_no.setVisible(true);
                                    jB_ok.setVisible(false);
                                    break;  //6 
            
            case LOCK_WAR_YES_NO :  jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images_conf/lock.png")));        
                                    jB_yes.setVisible(true);
                                    jB_no.setVisible(true);
                                    jB_ok.setVisible(false);
                                    break;  //7 
                                    
            case LOCK_WARNING:      jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images_conf/lock.png")));  
                                    break;  //8
        }
    }
