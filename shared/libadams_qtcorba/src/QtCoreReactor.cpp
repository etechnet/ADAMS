 ...
 * #
 */
//$Id: QtCoreReactor.cpp 82723 2008-09-16 09:35:44Z johnnyw $

#include <qtcorereactor.h>

ACE_BEGIN_VERSIONED_NAMESPACE_DECL

ACE_ALLOC_HOOK_DEFINE ( ACE_QtCoreReactor )

// Must be called with lock held

ACE_QtCoreReactor::ACE_QtCoreReactor ( QCoreApplication *qapp ,
                                       ACE_Sig_Handler *sh,
                                       ACE_Timer_Queue *tq,
...
// Must be called with lock held
ACE_QtCoreReactor::ACE_QtCoreReactor ( size_t size,
...
void ACE_QtCoreReactor::reopen_notification_pipe ( void )
{
	...
	// QtCoreReactor overloads this method BUT because the
	// register_handler_i occurs when constructing the base class
	// ACE_Select_Reactor, the ACE_Select_Reactor register_handler_i()
	// is called not the QtCoreReactor register_handler_i().  This means
	// that the notify pipe is registered with the ACE_Select_Reactor
	// event handling code not the QtCoreReactor and so notfications don't
	// work.  To get around this we simply close and re-opened the
	// notification handler in the constructor of the QtCoreReactor.
...
ACE_QtCoreReactor::~ACE_QtCoreReactor ( void )
{
	...
	while ( iter != iterEnd ) {
		...
		// QOBject destructor notifies qcoreapplication (hopefully) on delete
...
void
ACE_QtCoreReactor::qcoreapplication ( QCoreApplication *qapp )
{
...
void
ACE_QtCoreReactor::timeout_event ( void )
{
...
void
ACE_QtCoreReactor::read_event ( int p_handle )
{
	ACE_TRACE ( "ACE_QtCoreReactor::read_event" );
...
void
ACE_QtCoreReactor::write_event ( int p_handle )
{
	ACE_TRACE ( "ACE_QtCoreReactor::write_event" );
...
void
ACE_QtCoreReactor::exception_event ( int p_handle )
{
	ACE_TRACE ( "ACE_QtCoreReactor::exception_event" );
...
int
ACE_QtCoreReactor::set_enable_flag_by_mask ( int flag_value,
                ACE_HANDLE handle,
...
int
ACE_QtCoreReactor::bit_ops ( ACE_HANDLE handle,
                             ACE_Reactor_Mask mask,
                             ACE_Select_Reactor_Handle_Set &handle_set,
                             int ops )
{
...
void
ACE_QtCoreReactor::create_notifiers_for_handle ( ACE_HANDLE handle )
{
	QSocketNotifier *qsock_notifier = 0;
...
void
ACE_QtCoreReactor::destroy_notifiers_for_handle ( ACE_HANDLE handle )
{
	QSocketNotifier *qsock_notifier = 0;
...
int
ACE_QtCoreReactor::register_handler_i ( ACE_HANDLE handle ,
                                        ACE_Event_Handler *handler,
                                        ACE_Reactor_Mask mask )
{
	ACE_TRACE ( "ACE_QtCoreReactor::register_handler_i" );
...
int
ACE_QtCoreReactor::register_handler_i ( const ACE_Handle_Set &handles,
                                        ACE_Event_Handler *handler,
                                        ACE_Reactor_Mask mask )
{
...
int ACE_QtCoreReactor::remove_handler_i ( ACE_HANDLE handle ,
                ACE_Reactor_Mask mask )
{
	ACE_TRACE ( "ACE_QtCoreReactor::remove_handler_i" );
...
int
ACE_QtCoreReactor::remove_handler_i ( const ACE_Handle_Set &handles,
                                      ACE_Reactor_Mask  mask )
{
...
void
ACE_QtCoreReactor::reset_timeout ( void )
{
	if ( this->qtime_ != 0 ) {
		delete this->qtime_;
		this->qtime_ = 0;
...
long
ACE_QtCoreReactor::schedule_timer ( ACE_Event_Handler *handler,
                                    const void *arg,
                                    const ACE_Time_Value &delay_time,
                                    const ACE_Time_Value &interval )
{
	ACE_TRACE ( "ACE_QtCoreReactor::schedule_timer" );
...
int
ACE_QtCoreReactor::cancel_timer ( ACE_Event_Handler *handler,
                                  int dont_call_handle_close )
{
	ACE_TRACE ( "ACE_QtCoreReactor::cancel_timer" );
...
int ACE_QtCoreReactor::cancel_timer ( long  timer_id,
                                      const void **arg,
                                      int dont_call_handle_close )
{
	ACE_TRACE ( "ACE_QtCoreReactor::cancel_timer" ) ;
...
int
ACE_QtCoreReactor::QtWaitForMultipleEvents ( int width,
...
int
ACE_QtCoreReactor::wait_for_multiple_events (
        ACE_Select_Reactor_Handle_Set &handle_set,
        ACE_Time_Value *max_wait_time )
{
	ACE_TRACE ( "ACE_QtCoreReactor::wait_for_multiple_events" );
