...
#ifndef APIDB_PLUGINREGOSTRY_H
#define APIDB_PLUGINREGOSTRY_H
 ...
 */
class APIDB_PluginRegistryTable: public APIDB_Base
{
public:
	 ...
	 */
	APIDB_PluginRegistryTable ();
	APIDB_PluginRegistryTable (AdamsCompleteConfig *adc);
