 ...
 *chiusura Database.
 */
public class ADAMS_IOR_DBConnection
{
    // The driver to load
    private final String driver_class 	= "com.mysql.jdbc.Driver"; //mysql
    private final String name_db 	= "adams_ssm"; //mysql
   ...
   */
    public synchronized int Operation(String sqlstm)
    {
        ...
        catch(java.sql.SQLException exc) 
        {
            ...
            ADAMS_IOR_GlobalParam.optionPanel((javax.swing.JFrame)null,"ORACLE ERROR:"+exc.toString(),"ERROR",1);
            x = -1;
        }
    ...
    {     
        ...
        catch(java.sql.SQLException exc) 
        {
            ...
            ADAMS_IOR_GlobalParam.optionPanel((javax.swing.JFrame)null,"createLocalStatement ORACLE ERROR:"+exc.toString(),"ERROR",1);
        }
    ...
    {      
        ...
        catch(java.sql.SQLException exc) 
        {
            ...
            ADAMS_IOR_GlobalParam.optionPanel((javax.swing.JFrame)null,"Query_rs ORACLE ERROR:"+exc.toString(),"ERROR",1);
        }
    ...
    {        
        ...
        catch(java.sql.SQLException exc) 
        {
            ...
            ADAMS_IOR_GlobalParam.optionPanel((javax.swing.JFrame)null,"Query_rs_Statement ORACLE ERROR:"+exc.toString(),"ERROR",1);
        }
    ...
    public synchronized int Query_rs_update(String sqlstm) 
    {
        ...
        catch(java.sql.SQLException exc) 
        {
            ...
            ADAMS_IOR_GlobalParam.optionPanel((javax.swing.JFrame)null,"Query_rs_update ORACLE ERROR:"+exc.toString(),"ERROR",1);
            rsQuery=-1;
        }
      ...
      //System.out.println("&&&&&&&&& Query rsQuery "+rsQuery);
       ...
       ResultSet rsQuery         = null; 
        ...
        catch(java.sql.SQLException exc) 
        {
            ...
            ADAMS_IOR_GlobalParam.optionPanel((javax.swing.JFrame)null,"Query ORACLE ERROR:"+exc.toString(),"ERROR",1);
        }
    ...
    */
    ...
    {    
        ...
        catch(java.sql.SQLException exc)
        {
            ...
            ADAMS_IOR_GlobalParam.optionPanel((javax.swing.JFrame)null,"Query_s ORACLE ERROR:"+exc.toString(),"ERROR",1);
        }
    ...
    */
    ...
    {    
        ...
        catch(java.sql.SQLException exc)
        {
            ...
            ADAMS_IOR_GlobalParam.optionPanel((javax.swing.JFrame)null,"Query_int ORACLE ERROR:"+exc.toString(),"ERROR",1);
        }
