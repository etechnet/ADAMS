...
public class ADAMS_IOR_JD_Message extends javax.swing.JDialog {
    
    /** Creates new form ADAMS_IOR_JD_Message */    
    public ADAMS_IOR_JD_Message(javax.swing.JDialog parent, boolean modal, String message, String title ,int Value_type) {
        super(parent, modal);
        ...
        jLabel1.setFont(ADAMS_IOR_GlobalParam.font_B11);
        jTextArea1.setFont(ADAMS_IOR_GlobalParam.font_B11);
    ...
    /** Creates new form ADAMS_IOR_JD_Message */    
    public ADAMS_IOR_JD_Message(javax.swing.JDialog parent, boolean modal, String message, String title ,int Value_type,int width,int height ) {
        super(parent, modal);
        this.JD_TYPE = Value_type;
        initComponents();
    ...
    /** Creates new form ADAMS_IOR_JD_Message */    
    public ADAMS_IOR_JD_Message(javax.swing.JFrame parent, boolean modal, String message, String title ,int Value_type) {
    ...
    /** Creates new form ADAMS_IOR_JD_Message */    
    public ADAMS_IOR_JD_Message(javax.swing.JFrame parent, boolean modal, String message, String title ,int Value_type,int width,int height ) {
        super((java.awt.Frame)parent, modal);
        this.JD_TYPE = Value_type;
        initComponents();
