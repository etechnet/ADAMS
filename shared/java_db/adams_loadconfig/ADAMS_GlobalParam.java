...
public class ADAMS_GlobalParam
{
    ...
    public static boolean DEBUG_ALARM           = false;
    ...
    public static int           ID_ANALISI_SELEZIONATA      = -1; //ï¿½ stata messa per evitare un giro infinito di variabili tra i vari form.
    public static String        TAG_SELEZIONATO             = "";
    public static int           INSERT_NEW_ELEMENT          = 0; //ï¿½ stata messa per evitare un giro infinito di variabili tra i vari form.
    public static int           MODIFY_ELEMENT              = 0; //ï¿½ stata messa per evitare un giro infinito di variabili tra i vari form.
