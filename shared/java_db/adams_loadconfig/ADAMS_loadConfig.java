...
public class ADAMS_loadConfig {

	private boolean	CONN_ORACLE		= false;
	public ADAMS_COMPLETE_CONFIG ntmComplete		= new ADAMS_COMPLETE_CONFIG();
	ADAMS_TAB_EXTERNAL externalTab		= new ADAMS_TAB_EXTERNAL();
	DATA_CENTRALI centrali[]		= null;
	...
	public ADAMS_loadConfig()
	{
		...
		CONN_ORACLE = ADAMS_GlobalParam.connect_Oracle.DBConnect("","","");
    ...
    public boolean get_PLUGINCONFIG() //Raffo
    {
        ...
        {
            System.out.println("ADAMS_loadConfig [get_PLUGINCONFIG] ----> MANCA IL NOME DELLA CONFIGURAZIONE.");
            return false;
        }

        if(vPlugin==null)
        {
            System.out.println("ADAMS_loadConfig [get_PLUGINCONFIG] ----> NON SONO STATI CARICATI I PLUGIN.");
            return false;
        }
        ...
        {
           System.out.println("ADAMS_loadConfig [get_PLUGINCONFIG] ---> sono presenti "+len_pl+" Plugin");
        }
        ...
        if(len_pl>0)
        {
            ...
            for(int i=0;i<len_pl;i++)
            {
                ...
                {
                   System.out.println();
                   System.out.println("ADAMS_loadConfig [get_PLUGINCONFIG] ---> Plugin Nome: "+p.NOME_PLUGIN);
        ...
        {
            if(ADAMS_GlobalParam.DEBUG)
                System.out.println("ADAMS_loadConfig [get_PLUGINCONFIG] ----> NON CI SONO PLUGIN.");
    ...
    public boolean get_USERCONFIG() //Raffo
    {
        ...
        if(config_NAME_ALIAS==null)
        {
            System.out.println("ADAMS_loadConfig [get_USERCONFIG] ----> MANCA IL NOME DELLA CONFIGURAZIONE.");
            return false;
        }
        ...
        }else
        {
            ...
            if(ADAMS_GlobalParam.DEBUG)
                System.out.println("ADAMS_loadConfig [get_USERCONFIG] ----> NON CI SONO UTENTI.");
    ...
    public boolean get_DRCONFIG()
    {
        ...
        if(config_NAME_ALIAS==null)
        {
            System.out.println("ADAMS_loadConfig [get_DRCONFIG] ----> MANCA IL NOME DELLA CONFIGURAZIONE.");
            return false;
        }
        ...
        if(ADAMS_GlobalParam.DEBUG)
        {
           System.out.println("ADAMS_loadConfig [get_DRCONFIG] ----> sono presenti "+nDATA_DR+" DR");
        }
            ...
            for(int i=0;i<nDATA_DR;i++)
            {
                ...
                if(row_TAB_CONFIG!=null)
                {
                    ...
                    if(ADAMS_GlobalParam.DEBUG)
                    {
                       ...
                       System.out.println("DR---> POSIZIONE_ELEMENTO: "+row_TAB_CONFIG.POSIZIONE_CAMPO_DR);
                       System.out.println("DR---> TIPO_CAMPO("+row_TAB_CONFIG.TIPO_CAMPO+"): "+typeList.idType(row_TAB_CONFIG.TIPO_CAMPO));
        ...
        {
            if(ADAMS_GlobalParam.DEBUG)
                System.out.println("ADAMS_loadConfig [get_DRCONFIG] ----> NON CI SONO DR.");
    ...
    public boolean get_ANALISICONFIG()  // ****** get_ANALISICONFIG() -- ATTENZIONE va chimato dopo get_ADAMSConfIG() ****** //
    {
        ...
        if(config_NAME_ALIAS==null)
        {
            System.out.println("ADAMS_loadConfig [get_ANALISI] ----> MANCA IL NOME DELLA CONFIGURAZIONE.");
            return flag;
        }
        ...
        if(rs != null)
        {
            try
            {
                while ( rs.next() )
                {
                    ...
                    if(ADAMS_GlobalParam.DEBUG)
                    {
                        System.out.println("ADAMS_loadConfig [get_ANALISI] ----> selectRead : "+selectReadNested);
                    }
                    ...
                    {
                        System.out.println("ADAMS_loadConfig [get_ANALISI] ----> rsNested == null");
                    }
                    ...
                    {
                        System.out.println("ADAMS_loadConfig [get_ANALISI] ----> SQL Operation(Nested analisi) " + exc.toString());
                    }
                    ...
                    {
                        System.out.println();
                        System.out.println("ADAMS_loadConfig [get_ANALISI] ----> Analisi TIPO_DI_CONFIGURAZIONE :"+row_Analysis.TIPO_DI_CONFIGURAZIONE+"---");
        ...
        {
            System.out.println("ADAMS_loadConfig [get_ANALISI] ---->  SQL Operation " + exc.toString());
        }
        ...
        if(ADAMS_GlobalParam.DEBUG)
        {
           System.out.println("ADAMS_loadConfig [get_ANALISI] ----> sono presenti "+nDATA_ANALYSISTYPE+" Analisi");
        }
        ...
        if(nDATA_ANALYSISTYPE>0)
        {
            ...
            for(int i=0;i<nDATA_ANALYSISTYPE;i++)
            {
                    ...
                    if(ADAMS_GlobalParam.DEBUG)
                    {
                        System.out.println("ADAMS_loadConfig [get_ANALISI] ---> "+row_Analysis.NOMEANALISI+","+row_Analysis.IDANALISI);
                    }
        ...
        {
            if(ADAMS_GlobalParam.DEBUG)
                System.out.println("ADAMS_loadConfig [get_ANALISI] ----> NON CI SONO ANALISI.");
    ...
    {
        boolean flag=false;
        ADAMS_VectorHelp vHELP = new ADAMS_VectorHelp(ADAMS_GlobalParam.ALL_CONF_forhelp,ADAMS_GlobalParam.TYPE_HELP_TRIGGER);
        if(config_NAME_ALIAS==null)
        {
            System.out.println("ADAMS_loadConfig [get_EXCEPTIONCONFIG] ----> MANCA IL NOME DELLA CONFIGURAZIONE.");
            return false;
        }
        ...
        if(ADAMS_GlobalParam.DEBUG)
        {
           System.out.println("ADAMS_loadConfig [get_EXCEPTIONCONFIG] ---> sono presenti "+nDATA_EXCEPTIONS+" Eccezioni");
        }
        ...
        if(nDATA_EXCEPTIONS>0)
        {
            ...
            for(int i=0;i<nDATA_EXCEPTIONS;i++)
            {
                ...
                if(ADAMS_GlobalParam.DEBUG)
                {
                    System.out.println("ADAMS_loadConfig [get_EXCEPTIONCONFIG] ---> "+ex.TAG+","+ex.IDEXCEPTION);
                }
        ...
        {
            if(ADAMS_GlobalParam.DEBUG)
                System.out.println("ADAMS_loadConfig [get_EXCEPTIONCONFIG] --->  NON CI SONO ECCEZIONI.");
    ...
    public boolean get_SCRIPTCONFIG() //Raffo
    {
        ...
        boolean flag = false;
        ADAMS_VectorHelp vHELP = new ADAMS_VectorHelp(ADAMS_GlobalParam.ALL_CONF_forhelp,ADAMS_GlobalParam.TYPE_RESULT_SCTRIPT);
        if(config_NAME_ALIAS==null)
        {
            System.out.println("ADAMS_loadConfig [get_SCRIPTCONFIG] ----> MANCA IL NOME DELLA CONFIGURAZIONE.");
            return false;
        }
        ...
        if(ADAMS_GlobalParam.DEBUG)
        {
            System.out.println("ADAMS_loadConfig [get_SCRIPTCONFIG] ----> "+strSelect);
        }
        ...
        if(rs != null)
        {
            try
            {
                while ( rs.next() )
                {
                    ...
                    ADAMS_ScriptObject scriptLetto=new ADAMS_ScriptObject();
        ...
        {
            System.out.println("ADAMS_loadConfig [get_SCRIPTCONFIG] ---> rs==null");
        }
        ...
        {
            System.out.println("ADAMS_loadConfig [get_SCRIPTCONFIG] ---> ERROR-SQL Operation " + exc.toString());
        }
        ...
        if(ADAMS_GlobalParam.DEBUG)
        {
           System.out.println("ADAMS_loadConfig [get_SCRIPTCONFIG] ---> sono presenti "+len_script+" Script");
        }
        ...
        if(len_script>0)
        {
            ...
            {
                ADAMS_ScriptObject sc=(ADAMS_ScriptObject)vScript.elementAt(i);

                if(ADAMS_GlobalParam.DEBUG)
                {
                    System.out.println("ADAMS_loadConfig [get_SCRIPTCONFIG] ---> "+sc.sc.TAG+","+sc.sc.IDSCRIPT);
                }
                ...
                if(ADAMS_GlobalParam.DEBUG)
                {
                    //System.out.println("ADAMS_loadConfig [get_SCRIPTCONFIG] ---> sc.sc.RESULTTYPE="+sc.sc.RESULTTYPE);
                    //System.out.println("ADAMS_loadConfig [get_SCRIPTCONFIG] ---> vHELP.getValue(sc.sc.RESULTTYPE)="+vHELP.getValue(sc.sc.RESULTTYPE));
                    System.out.println("ADAMS_loadConfig [get_SCRIPTCONFIG] ---> nDATA_SCRIPT_VARLIST="+nDATA_SCRIPT_VARLIST);
                }
                if(nDATA_SCRIPT_VARLIST>0)
                {
                    ...
                    for(int k=0;k<sc.sc.NUMVARIABLE1;k++)
                    {
                        ...
                        if(ADAMS_GlobalParam.DEBUG)
                        {
                            System.out.println("ADAMS_loadConfig [get_SCRIPTCONFIG] ---> nome Var="+appo);
                        }
                        cont++;
                    }
                ...
                if(ADAMS_GlobalParam.DEBUG)
                {
                    System.out.println("ADAMS_loadConfig [get_SCRIPTCONFIG] ---> nDATA_SCRIPT_TEXT="+nDATA_SCRIPT_TEXT);
                }
        ...
        {
            if(ADAMS_GlobalParam.DEBUG)
                System.out.println("ADAMS_loadConfig [get_SCRIPTCONFIG] ----> NON CI SONO SCRIPT.");
    ...
    {
    	ADAMS_VectorHelp vHELP_COUNTER_INDEX = new ADAMS_VectorHelp(ADAMS_GlobalParam.ALL_CONF_forhelp,ADAMS_GlobalParam.TYPE_COUNTER_INDEX);

        //ADAMS_GlobalParam.DEBUG=true;
        if(config_NAME_ALIAS==null)
        {
            System.out.println("ADAMS_loadConfig [get_REPORTCONFIG] ----> MANCA IL NOME DELLA CONFIGURAZIONE.");
            return false;
        }
        ...
        if(ADAMS_GlobalParam.DEBUG)
            System.out.println("ADAMS_loadConfig [get_REPORTCONFIG] ----> "+strSelect);
        ...
        if(rs != null)
        {
            try
            {
                while ( rs.next() )
                {
                    ...
                    if(nomeSchema!=null)
                    {
                        ADAMS_ReportObject schemaAttuale=new ADAMS_ReportObject(config_NAME_ALIAS,nomeSchema);
        ...
        {
            System.out.println("ADAMS_loadConfig [get_REPORTCONFIG] ---> rs==null");
        }
        ...
        {
            System.out.println("ADAMS_loadConfig [get_REPORTCONFIG] ---> ERROR-SQL Operation " + exc.toString());
        }
        ...
        {
             ADAMS_ReportObject appo=(ADAMS_ReportObject)vReport.elementAt(i);
        ...
        if(ADAMS_GlobalParam.DEBUG)
        {
           System.out.println("ADAMS_loadConfig [get_REPORTCONFIG] ---> sono presenti "+nSchemi+" Schemi");
           System.out.println("ADAMS_loadConfig [get_REPORTCONFIG] ---> sono presenti "+numRighe+" Righe");
        }
        ...
        if(numRighe>0)
        {
            ...
            for(int i=0;i<nSchemi;i++)
            {
                ADAMS_ReportObject schema=(ADAMS_ReportObject)vReport.elementAt(i);



                ADAMS_ReportObject.elementoBase reportObj=schema.getHeaderReport();
                ...
                Vector vHeader=schema.getVectorObject(ADAMS_ReportObject.HEADER);
                int len_vHeader=vHeader.size();
                if(ADAMS_GlobalParam.DEBUG)
                {
                    System.out.println("ADAMS_loadConfig [get_REPORTCONFIG] ---> sono presenti "+len_vHeader+" HEADER");
                }
                if(len_vHeader>0)
                {
                    ...
                    {
                        ADAMS_ReportObject.elementoBase eb=(ADAMS_ReportObject.elementoBase)vHeader.elementAt(j);
                        ...
                        switch(eb.SUB_TYPE)
                        {
                            case ADAMS_ReportObject.LINE_BLANK:
                                typeSeparetor=1;
                                break;

                            case ADAMS_ReportObject.LINE_BREAK:
                                typeSeparetor=2;
                                break;

                            case ADAMS_ReportObject.LINE_SEPARETOR:
                                typeSeparetor=3;
                                break;
                        }
                ...
                {
                    if(ADAMS_GlobalParam.DEBUG)
                        System.out.println("ADAMS_loadConfig [get_REPORTCONFIG] ---> NON CI SONO HEADER");
		...
		/**************************************************************/
                ...
                Vector vBody=schema.getVectorObject(ADAMS_ReportObject.BODY);
                int len_vBody=vBody.size();
                if(ADAMS_GlobalParam.DEBUG)
                {
                    System.out.println("ADAMS_loadConfig [get_REPORTCONFIG] ---> sono presenti "+len_vBody+" BODY");
                }
                if(len_vBody>0)
                {
                    ...
                    {
                        ADAMS_ReportObject.elementoBase eb=(ADAMS_ReportObject.elementoBase)vBody.elementAt(j);
                ...
                {
                    if(ADAMS_GlobalParam.DEBUG)
                        System.out.println("ADAMS_loadConfig [get_REPORTCONFIG] ---> NON CI SONO BODY");

                    bodyNULL(i);
                }

                /**********************************  PRENDO I TOTALIZER **********************************************************/
                Vector vTot=schema.getVectorObject(ADAMS_ReportObject.TOTALIZER);
                int len_vTot=vTot.size();
                if(ADAMS_GlobalParam.DEBUG)
                {
                    System.out.println("ADAMS_loadConfig [get_REPORTCONFIG] ---> sono presenti "+len_vTot+" TOTALIZER");
                }
                if(len_vTot>0)
                {
                    ...
                    {
                        ADAMS_ReportObject.elementoBase eb=(ADAMS_ReportObject.elementoBase)vTot.elementAt(j);
                ...
                else
                {
                    ...
                    if(ADAMS_GlobalParam.DEBUG)
                        System.out.println("ADAMS_loadConfig [get_REPORTCONFIG] ---> NON CI SONO TOTALIZER");

                    totalizerNULL(i);
                }

                /**********************************  PRENDO I FOOTER **********************************************************/
                Vector vFooter=schema.getVectorObject(ADAMS_ReportObject.FOOTER);
                int len_vFooter=vFooter.size();
                if(ADAMS_GlobalParam.DEBUG)
                {
                    System.out.println("ADAMS_loadConfig [get_REPORTCONFIG] ---> sono presenti "+len_vFooter+" FOOTER");
                }
                if(len_vFooter>0)
                {
                    ...
                    {
                        ADAMS_ReportObject.elementoBase eb=(ADAMS_ReportObject.elementoBase)vFooter.elementAt(j);
                ...
                {
                    if(ADAMS_GlobalParam.DEBUG)
                        System.out.println("ADAMS_loadConfig [get_REPORTCONFIG] ---> NON CI SONO FOOTER");
        ...
        {
            if(ADAMS_GlobalParam.DEBUG)
                System.out.println("ADAMS_loadConfig [get_REPORTCONFIG] ---> NON CI SONO REPORT");
   ...
   public boolean get_AlarmCONFIG() //
   {
       //System.out.println("get_AlarmCONFIG( ...... )");

        if(config_NAME_ALIAS==null)
        {
            System.out.println("ADAMS_loadConfig [get_ADAMSConfIG] ----> MANCA IL NOME DELLA CONFIGURAZIONE.");
            return false;
        }

        if(vPlugin==null)
        {
            System.out.println("ADAMS_loadConfig [get_ADAMSConfIG] ----> NON SONO STATI CARICATI I PLUGIN.");
            return false;
        }
...
// ======   Popolo Struttura ALARM_RELATION
        ...
        if(ADAMS_GlobalParam.DEBUG_ALARM)
        {
...
// ====== END Popolo Struttura THRESHOLD_GENERATOR
    ...
    public boolean get_ADAMSConfIG(boolean ADD_FREE_RELATION)
    {
        ADAMS_VectorHelp vHELP_GUI = new ADAMS_VectorHelp(ADAMS_GlobalParam.ALL_CONF_forhelp,ADAMS_GlobalParam.TYPE_HELP_GUI);
        ADAMS_VectorHelp vHELP_COMPARE = new ADAMS_VectorHelp(ADAMS_GlobalParam.ALL_CONF_forhelp,ADAMS_GlobalParam.TYPE_HELP_GENERIC);
        ...
        for(int c=0; c<vRelation.size(); c++)
        {
            ...
            if(elem_relation.DIREZIONE>=40) //Raffo, per gestione id direzione su restruizioni
            {
                ...
                //il 40 perchï¿½ attualmente gli id delle direzioni partono da 40 anzichï¿½ 1.
            }else
            {
            ...
            ntmComplete.relationSequence[c]     = new DATA_RELATIONS(   elem_relation.idRelation,
                 ...
                 System.out.println("idRelation="+elem_relation.idRelation);
                 System.out.print("restrictions (");                                                   
              for(int m=0; m<restrictions.length;m++)
                {
                 
                   System.out.print(restrictions[m]);
                   System.out.print(",");
                }System.out.println(")");
                 System.out.print("tiedRestrictions (");                                                   
              for(int m=0; m<tiedRestrictions.length; m++)
                {
                 
                   System.out.print(tiedRestrictions[m]);
                   System.out.print(",");
                }System.out.println(")");
        ...
        if(nDATA_DATAELEMENT > 0)
        {
            ...
            for(int i=0; i<nDATA_DATAELEMENT; i++)
            {
                ...
                if(row_TE != null)
                {
                    ...
                    for(int q=0; q<_VALSHIFTER_MAX; q++)
                    {
			...
			scripts[j]=0;
                ...
                if(ADAMS_GlobalParam.DEBUG)
                {
                    ...
                    for(int j=0;j<5;j++)
                    {
                    System.out.println("   ntmComplete.elementSequence[i].exceptions[j]         "+ntmComplete.elementSequence[i].exceptions[j]);
                    }
                   /* for(int k=0;k<_VALSHIFTER_MAX;k++)
                    {
                    System.out.println("   ntmComplete.elementSequence[i].valueShifter[k]         "+new String(ntmComplete.elementSequence[i].valueShifter[k]));
                    }*/
                    System.out.println();
                }
    ...
    public boolean get_COUNTERKIT() //
    {
        ADAMS_VectorHelp vHELP_COUNTER_INDEX = new ADAMS_VectorHelp(ADAMS_GlobalParam.ALL_CONF_forhelp,ADAMS_GlobalParam.TYPE_COUNTER_INDEX);
        ADAMS_VectorHelp vHELP_COUNTER_TYPE = new ADAMS_VectorHelp(ADAMS_GlobalParam.ALL_CONF_forhelp,ADAMS_GlobalParam.TYPE_COUNTER_TYPE);
        ADAMS_VectorHelp vHELP_PERCENT_OF = new ADAMS_VectorHelp(ADAMS_GlobalParam.ALL_CONF_forhelp,ADAMS_GlobalParam.TYPE_PERCENT_OF);
        ...
        if(config_NAME_ALIAS==null)
        {
            System.out.println("ADAMS_loadConfig [get_COUNTERKIT] ----> MANCA IL NOME DELLA CONFIGURAZIONE.");
            return false;
        }
    ...
    public boolean get_GLOBALOPT() //
    {
        ...
        if(config_NAME_ALIAS==null)
        {
            System.out.println("ADAMS_loadConfig [get_GLOBALOPT] ----> MANCA IL NOME DELLA CONFIGURAZIONE.");
            return false;
        }
	...
	public boolean get_Centrali()
	{
		externalTab.readCentrali();
		if(ADAMS_GlobalParam.DEBUG)
            	{
			externalTab.stampaCentrali();
			System.out.println("externalTab.numCentraliAttive()="+externalTab.numCentraliAttive());
			System.out.println("externalTab.numCentraliAttive()="+externalTab.numCentrali());
		}

		int numCentraliAttive	= externalTab.numCentraliAttive();
		int numCentrali		= externalTab.numCentrali();
		int cont		= 0;

		centrali=new DATA_CENTRALI[numCentrali];

		Vector vCENTRALI=externalTab.getCentrali();

		for(int i=0;i<numCentrali;i++)
		{
			ADAMS_TAB_EXTERNAL.TAB_CENTRALI_ROW appo=(ADAMS_TAB_EXTERNAL.TAB_CENTRALI_ROW)vCENTRALI.elementAt(i);
			if(appo.FLAG_ATT==1) // carica solo le centrali attive
			{
				centrali[cont]=new DATA_CENTRALI(appo.IND_CEN,set_String_toChar(appo.CENT,_SHORT_DESC_LEN));
				cont++;
			}else
			{
				centrali[cont]=new DATA_CENTRALI(-1,set_String_toChar("",_SHORT_DESC_LEN));
				cont++;
			}
		}
	...
	public boolean load_ADAMSConfIG(String nameConf)
	{
		set_config_NAME_ALIAS(nameConf);
		get_SCRIPTCONFIG();
		get_EXCEPTIONCONFIG();
		get_USERCONFIG();
		get_DRCONFIG();
		...
		get_ADAMSConfIG(ADD_FREE_RELATION);
		get_ANALISICONFIG();
		get_COUNTERKIT();
		get_REPORTCONFIG();
		get_AlarmCONFIG();
    	...
    	public ADAMS_COMPLETE_CONFIG getADAMSComplete()
	{
		return ntmComplete;
	}

	public Object getADAMSExternal(int table)
	{
		switch(table)
		{
			case ADAMS_TAB_EXTERNAL.EXTERNAL_CENTRALI:
			{
				return (DATA_CENTRALI[])centrali;
			}
     ...
     * @param str String il cui contenuto sarï¿½ copiato nell'array di char.
