...
public class ADAMS_ScriptObject {
    ...
    public boolean readScript(String nameConfig,int idScript)
    {
        ...
        if(ADAMS_GlobalParam.DEBUG)
           System.out.println("ADAMS_ScriptObject [readScript] ----> "+strSelect);
        ...
        {
            System.out.println("ADAMS_ScriptObject [readScript] ----> rs==null");
            flag=false;
        }
