...
CLIENT_DNAME="cn=ADAMS LoadConfig,ou=ASP,o=e-Tech,c=IT"
CLIENT_ALIAS="adams_loadconfig"
CLIENT_PW="adams_loadconfig_signer_pw_1"
CLIENT_PW2="adams_loadconfig_signer_pw_2"
CLIENT_KEYSTORE="$CLIENT_ALIAS".jks
CLIENT_CERTFILE="$CLIENT_ALIAS".cert

SERVER_DNAME="cn=ADAMS LoadConfig,ou=ASP,o=e-Tech,c=IT"
SERVER_ALIAS="adams_loadconfig_server"
SERVER_PW="adams_loadconfig_signer_pw_1"
