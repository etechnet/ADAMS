...
/****************************************************************************
** $Id: qt/qmap.cpp   3.3.8   edited Jan 11 14:38 $
**
...
typedef ADAMSMapNodeBase* NodePtr;
typedef ADAMSMapNodeBase Node;


void ADAMSMapPrivateBase::rotateLeft ( NodePtr x, NodePtr& root )
{
	NodePtr y = x->right;
	x->right = y->left;
	if ( y->left != 0 )
...
void ADAMSMapPrivateBase::rotateRight ( NodePtr x, NodePtr& root )
{
	NodePtr y = x->left;
	x->left = y->right;
	if ( y->right != 0 )
...
void ADAMSMapPrivateBase::rebalance ( NodePtr x, NodePtr& root )
{
	x->color = Node::Red;
...
NodePtr ADAMSMapPrivateBase::removeAndRebalance ( NodePtr z, NodePtr& root,
                NodePtr& leftmost,
                NodePtr& rightmost )
{
	NodePtr y = z;
