...
struct Q_CORE_EXPORT LLocalePrivate
{
public:
...
inline char LLocalePrivate::digitToCLocale(const QChar &in) const
{
...
#if defined(Q_OS_SYMBIAN) && !defined(QT_NO_SYSTEMLOCALE)
class LEnvironmentChangeNotifier
{
public:
    LEnvironmentChangeNotifier();
    ~LEnvironmentChangeNotifier();
